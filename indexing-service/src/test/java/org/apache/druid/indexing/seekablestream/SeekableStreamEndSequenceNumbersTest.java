...
// final SeekableStreamEndSequenceNumbers<Integer, Long> partitions = new
...
// // Check round-trip.
// final SeekableStreamEndSequenceNumbers<Integer, Long> partitions2 =
...
// Assert.assertEquals(
// offsetMap,
// OBJECT_MAPPER.convertValue(asMap.get("partitionSequenceNumberMap"), new
...
// final SeekableStreamEndSequenceNumbers<Integer, Long> endSequenceNumbers =
...
// Assert.assertEquals(
// new SeekableStreamStartSequenceNumbers<>(stream, offsetMap,
// ImmutableSet.of(1, 3)),
