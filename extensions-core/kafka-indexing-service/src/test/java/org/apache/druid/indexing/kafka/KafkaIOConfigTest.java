...
// + " \"startPartitions\": {\"topic\":\"mytopic\", \"partitionOffsetMap\" :
// {\"0\":1, \"1\":10}},\n"
// + " \"endPartitions\": {\"topic\":\"mytopic\", \"partitionOffsetMap\" :
// {\"0\":15, \"1\":200}},\n"
...
// Assert.assertEquals(ImmutableMap.of(0, 1L, 1, 10L),
...
// Assert.assertEquals(ImmutableMap.of(0, 15L, 1, 200L),
// config.getEndSequenceNumbers().getPartitionSequenceNumberMap());
// Assert.assertEquals(ImmutableMap.of("bootstrap.servers", "localhost:9092"),
...
// + " \"taskGroupId\": 0,\n"
// + " \"baseSequenceName\": \"my-sequence-name\",\n"
// + " \"startSequenceNumbers\": {\"type\":\"start\", \"stream\":\"mytopic\",
// \"partitionSequenceNumberMap\" : {\"0\":1, \"1\":10}},\n"
// + " \"endSequenceNumbers\": {\"type\":\"end\", \"stream\":\"mytopic\",
...
// + " \"startPartitions\": {\"topic\":\"mytopic\", \"partitionOffsetMap\" :
// {\"0\":1, \"1\":10}},\n"
// + " \"endPartitions\": {\"topic\":\"other\", \"partitionOffsetMap\" :
// {\"0\":15, \"1\":200}},\n"
// + " \"consumerProperties\": {\"bootstrap.servers\":\"localhost:9092\"},\n"
// + " \"useTransaction\": false,\n"
// + " \"minimumMessageTime\": \"2016-05-31T12:00Z\",\n"
...
// exception.expectMessage(CoreMatchers.containsString("start topic/stream and
// end topic/stream must match"));
// mapper.readValue(jsonStr, IOConfig.class);
// }
...
// exception.expect(JsonMappingException.class);
// exception.expectCause(CoreMatchers.isA(IllegalArgumentException.class));
// exception.expectMessage(CoreMatchers.containsString("start partition set and
// end partition set must match"));
// mapper.readValue(jsonStr, IOConfig.class);
// }
...
// exception.expect(JsonMappingException.class);
// exception.expectCause(CoreMatchers.isA(IllegalArgumentException.class));
// exception.expectMessage(CoreMatchers.containsString("end offset must be >=
// start offset"));
// mapper.readValue(jsonStr, IOConfig.class);
// }
...
// null,
// null,
// new SeekableStreamStartSequenceNumbers<>("stream", ImmutableMap.of(1, 10L, 2,
// 5L), null),
// new SeekableStreamEndSequenceNumbers<>("stream", ImmutableMap.of(1, 20L, 2,
// 30L)),
...
// oldMapper.registerSubtypes(new NamedType(OldKafkaIndexTaskIoConfig.class,
// "kafka"));
// final OldKafkaIndexTaskIoConfig oldConfig = (OldKafkaIndexTaskIoConfig)
// oldMapper.readValue(json, IOConfig.class);

// Assert.assertEquals(currentConfig.getTaskGroupId().intValue(),
// oldConfig.taskGroupId);
// Assert.assertEquals(currentConfig.getBaseSequenceName(),
// oldConfig.baseSequenceName);
// Assert.assertEquals(currentConfig.getStartSequenceNumbers(),
// oldConfig.startPartitions.asStartPartitions(true));
// Assert.assertEquals(currentConfig.getEndSequenceNumbers(),
// oldConfig.getEndPartitions());
// Assert.assertEquals(currentConfig.getConsumerProperties(),
// oldConfig.getConsumerProperties());
// Assert.assertEquals(currentConfig.getPollTimeout(),
// oldConfig.getPollTimeout());
// Assert.assertEquals(currentConfig.isUseTransaction(),
// oldConfig.isUseTransaction());
...
// 0,
// "baseSequenceNamee",
// new SeekableStreamEndSequenceNumbers<>("stream", ImmutableMap.of(1, 10L, 2,
// 5L)),
// new SeekableStreamEndSequenceNumbers<>("stream", ImmutableMap.of(1, 20L, 2,
// 30L)),
// ImmutableMap.of("consumer", "properties"),
...
// final KafkaIndexTaskIOConfig currentConfig = (KafkaIndexTaskIOConfig)
// mapper.readValue(json, IOConfig.class);
// Assert.assertEquals(oldConfig.getTaskGroupId(),
// currentConfig.getTaskGroupId().intValue());
// Assert.assertEquals(oldConfig.getBaseSequenceName(),
// currentConfig.getBaseSequenceName());
// Assert.assertEquals(oldConfig.getStartPartitions().asStartPartitions(true),
// currentConfig.getStartSequenceNumbers());
// Assert.assertEquals(oldConfig.getEndPartitions(),
// currentConfig.getEndSequenceNumbers());
// Assert.assertEquals(oldConfig.getConsumerProperties(),
// currentConfig.getConsumerProperties());
// Assert.assertEquals(oldConfig.getPollTimeout(),
// currentConfig.getPollTimeout());
// Assert.assertEquals(oldConfig.isUseTransaction(),
// currentConfig.isUseTransaction());
...
// private final SeekableStreamEndSequenceNumbers<Integer, Long>
// startPartitions;
...
// SeekableStreamEndSequenceNumbers<Integer, Long> startPartitions,
