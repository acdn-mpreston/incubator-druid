...
// {
// private static final KinesisDataSourceMetadata START0 =
// simpleStartMetadata(ImmutableMap.of());
// private static final KinesisDataSourceMetadata START1 =
// simpleStartMetadata(ImmutableMap.of("0", "2L", "1", "3L"));
// private static final KinesisDataSourceMetadata START2 = simpleStartMetadata(
// ImmutableMap.of("0", "2L", "1", "4L", "2", "5L")
// );
// private static final KinesisDataSourceMetadata START3 =
// simpleStartMetadata(ImmutableMap.of("0", "2L", "2", "5L"));
...
// ImmutableSet.of("0", "1")
// );
// private static final KinesisDataSourceMetadata END0 =
// endMetadata(ImmutableMap.of());
// private static final KinesisDataSourceMetadata END1 =
// endMetadata(ImmutableMap.of("0", "2L", "2", "5L"));
// private static final KinesisDataSourceMetadata END2 =
// endMetadata(ImmutableMap.of("0", "2L", "1", "4L"));
...
// private static KinesisDataSourceMetadata startMetadata(Map<String, String>
// sequences, Set<String> exclusivePartitions)
// {
// return new KinesisDataSourceMetadata(
// new SeekableStreamStartSequenceNumbers<>("foo", sequences,
// exclusivePartitions)
// );
// }

// private static KinesisDataSourceMetadata endMetadata(Map<String, String>
// sequences)
// {
